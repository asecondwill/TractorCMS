<div class="install form">
    ...
    <?php
        echo $this->Form->create('Install', array('url' => array( 'controller' => 'install', 'action' => 'database')));
        ...
        echo $this->Form->input('Install.database', array('label' => 'Name', 'default' => 'your_tractor_db'));
